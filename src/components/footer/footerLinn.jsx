  ...
  return (
    <div className="row justify-content-end">
      <div className="col-xl-4 col-lg-3 col-12 footer-about-widget">
        <div className="logo">
          <a href="index">
            <img src="images/logo/brandLogo.png" alt="" />
          </a>
        </div>
        <ul className="font-rubik mt-10">
          <li>
            <a href="mailto:deskiinc@gmail.com">Sales@linnseed.com</a>
          </li>
          <li>
            <a href="tel:(+91) 9111361111" className="phone">
              (+91) 9111361111
            </a>
          </li>
        </ul>
